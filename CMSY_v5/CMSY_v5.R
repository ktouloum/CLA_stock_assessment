...
test_CATCH_ID= tibble::as_tibble(test_CATCH_ID[,c("Continent","Region","Subregion","Group","ScientificName" ,"Stock")])
    ...
    "))
                                  ...
                                  column(width=8,
                                         conditionalPanel(condition = "input.Acc_rpriors",
                                                          ...
                                                          shinycssloaders::withSpinner(shiny::plotOutput(outputId = "Check_priors_plot",height = "580px"))
                                         ))),
                                ...
                                shiny::fluidRow(
                                  ...
                                  column(width=8,
                                         conditionalPanel(condition = "input.Priors_but2",
                                                          shinycssloaders::withSpinner(shiny::plotOutput(outputId = "Biomass_plot_3",height = "580px"))#,
                                                                                       ...
                                                                                       div(
                                                                                         ...
                                                                                         div(
                                                                                           ...
                                                                                           shinycssloaders::withSpinner(
                                                                                             shiny::plotOutput("rk_space", height = "500px"))),
                                                                                         div(
                                                                                           style = "height: 100px; overflow-y: auto; padding-top: 5px;",
                                                                                           shiny::h4("The graph shows as light grey dots the explored log r-k space. Black dots are viable r-k pairs found to be compatible with catch data and the priors, with the most probable r-k pair indicted by the red cross (with CI). The dotted rectangle indicates the prior r-k range."
                                                                                           ))),
                                                                                       width = 8,height = 620)
                                                                   ))),#),height = 250
                                         shiny::fluidRow(
                                                            ...
                                                            shinydashboard::box(collapsible = F,
                                                                                div(
                                                                                  ...
                                                                                  div(
                                                                                    style = "height: 500px;", 
                                                                                    shinycssloaders::withSpinner(
                                                                                      shiny::plotOutput("Catch_plot_final", height = "500px"))),
                                                                                  div(
                                                                                    style = "height: 100px; overflow-y: auto; padding-top: 5px;",
                                                                                    shiny::h4("The plot shows as blue curve the catch and as dashed horizontal line the estimate of MSY, both with indication of 95% CI."
                                                                                    ))),
                                                                                width = 12,height = 620)
                                                            )),
                                           shiny::fluidRow(
                                                             ...
                                                             shinydashboard::box(collapsible = F,
                                                                                 div(
                                                                                   ...
                                                                                   div(
                                                                                     style = "height: 500px;", 
                                                                                     shinycssloaders::withSpinner(
                                                                                       shiny::plotOutput("Pred_biom_plot", height = "500px"))),
                                                                                   div(
                                                                                     style = "height: 100px; overflow-y: auto; padding-top: 5px;",
                                                                                 ...
                                                                                 width = 12,height = 620))),#,height = 320
                                         shiny::fluidRow(
                                           conditionalPanel(condition = "input.Start_run",
                                                            shinydashboard::box(collapsible = F,
                                                                                div(
                                                                                  ...
                                                                                  div(
                                                                                    style = "height: 500px;", 
                                                                                    shinycssloaders::withSpinner(
                                                                                      shiny::plotOutput("Pred_FFmsy_plot", height = "500px"))),
                                                                                  div(
                                                                                    style = "height: 100px; overflow-y: auto; padding-top: 5px;",
                                                                                    shiny::h4("Exploitation (F/Fmsy) as estimated (blue), where the dashed horizontal line indicates Fmsy. The grey dots are the observed harvest rate scaled to results."
                                                                                    ))),
                                                                                width = 12,height = 620)
                                                            )),#,height = 320
                                                            ...
                                                            shinydashboard::box(collapsible = F,
                                                                                div(
                                                                                  ...
                                                                                  div(
                                                                                    style = "height: 500px;", 
                                                                                    shinycssloaders::withSpinner(
                                                                                      shiny::plotOutput("Parabola", height = "500px"))),
                                                                                  div(
                                                                                    style = "height: 100px; overflow-y: auto; padding-top: 5px;",
                                                                                    shiny::h4(tagList("Surplus production equilibrium parabola, with reduced productivity at small stock sizes. Overlaid are the corresponding modeled results for relative catch and stock size (red).", actionLink(inputId = "open_helpTablerk", label = "(More Guidance)")))
                                                                                  )),
                                                                                width = 12,height = 620)
                                                            )),
                                         shiny::fluidRow(
                                                            ...
                                                            shinydashboard::box(collapsible = F,
                                                                                div(
                                                                                  ...
                                                                                  div(
                                                                                    style = "height: 500px;", 
                                                                                    shinycssloaders::withSpinner(
                                                                                      shiny::plotOutput("kiel_plot", height = "500px"))),
                                                                                  div(
                                                                                    style = "height: 100px; overflow-y: auto; padding-top: 5px;",
                                                                   ...
                                                                   shinydashboard::box(collapsible = F,
                                                                                       div(
                                                                                         ...
                                                                                         div(
                                                                                           style = "height: 520px;", 
                                                                                           shinycssloaders::withSpinner(
                                                                                             shiny::plotOutput("kobe_plot", height = "520px"))),
                                                                                         div(
  ...
  #  shinyBS::toggleModal(session, "modalExample", toggle = "toggle")
    ...
    created_stock_object=eventReactive(input$button_2,{
      if(input$Crtd_StckID_input=="") {
        ...
        if(input$button_2 > 0) {
          Creatd_Stck_obj=CLA_stock_maker_empty_shiny(inp_data(),input$Crtd_StckID_input,input$Yr_col,input$ct_col,NA,input$cv_col,"No")#
          ...
          Creatd_Stck_obj$input$Input_parameters$btype=NA
        }
      }
   ...
   # output$lastButtonCliked=renderText({input$last_btn})
    ...
    output$Catch_plot2= shiny::renderPlot({
      fs <- responsive_font("Catch_plot2", session)
    ...
    output$Catch_plot= shiny::renderPlot({
      ...
      fs <- responsive_font("Catch_plot", session)
  ...
  #Final_stock <- Final_stock %>% debounce(1000)
      ...
      shinydashboard::valueBox(
        ...
        Catch_obj_=reactive({
          req(Final_stock())
          inp=Final_stock()[["input"]][["Input_data"]][,c("yr","ct")]
          inp$bt=NA
        ...
        output$Check_Catch_plot= shiny::renderPlot({
          fs <- responsive_font("Check_Catch_plot", session)
          xxx=Catch_obj_()$pic+theme_classic(base_size = fs)+
        ...
        #   temp_bio_obj =Bio_obj(inp,start_yr=NA, end_yr=NA,smoother_bw=NA,
        #                         ecreep=NA,ecreep_yr=NA,ecreepvalue=NA,
        #                         Biom_type=NA,CPUE_CV=NA,Plot=F,ShowCV=NA) 
        #   return(temp_bio_obj)
        # })
        # 
    ...
    output$Check_priors_plot= shiny::renderPlot({
      ...
      fs <- responsive_font("Check_priors_plot", session)
    ...
    output$Biomass_plot_3= shiny::renderPlot({
      req(Bk_obj())
      fs <- responsive_font("Biomass_plot_3", session)
      xxx=Bk_obj()$pic+
        ggplot2::theme_classic(base_size = fs)+ggplot2::theme(legend.position="bottom")
      print(xxx)
    })  
 ...
 # output$TESTNEURAL=renderTable({Fishbase_text()})
  ...
  #       })
   ...
   CMSY_run=eventReactive(input$Start_run,{
      CLA.fit(CLA_object(),METHOD="CMSY")
    })
    ...
    CLA_object_final=eventReactive(input$Start_run,{
      CLA_object_final_=extract.CLA.fit(CMSY_run(),CLA_object())
    })
    ...
    observeEvent(input$Start_run,{
      run_pictures$pic_A=ggrk.plot(CLA_object_final(),CMSY_run(),"CMSY") 
...
#     })
    ...
    output$ModOutp_31=renderUI({
      HTML(paste0(tags$b("Catch in last year  ="),format(tail(CLA_object_final()[["output"]][["output_timeseries"]]$Catch,1),digits = 3),
                  ", 2.5th perc =",format(tail(CLA_object_final()[["output"]][["output_timeseries"]]$Catch_low,1),digits = 3),", 97.5 perc =",
                  format(tail(CLA_object_final()[["output"]][["output_timeseries"]]$Catch_high,1),digits = 3)))#}
    }) 

   ############ Catch plot
    observeEvent(input$Start_run,{
      run_pictures$pic_B=ggcatch.plot(CLA_object_final(),METHOD = "CMSY") 
      pic_B_ready <- showNotification(paste("Message: ", "Catch graph ready"), duration = 5)
    })
    

    output$Catch_plot_final= shiny::renderPlot({
      fs <- responsive_font("Catch_plot_final", session)
      xxxx= run_pictures$pic_B+
        ggplot2::theme_classic(base_size = fs)+
        ggplot2::theme(legend.position="bottom")
      xxxx})#,height = 500

    observeEvent(input$Start_run,{
      run_pictures$pic_C=ggbk.plot(CLA_object_final(),"CMSY") 
    ...
    output$Pred_biom_plot= shiny::renderPlot({
      fs <- responsive_font("Pred_biom_plot", session)
      xxxx= run_pictures$pic_C+
        ggplot2::theme_classic(base_size = fs)+
        ggplot2::theme(legend.position="bottom")
      xxxx
    })
###### FFmsy PLOT
    observeEvent(input$Start_run,{
      run_pictures$pic_D=ggFFmsy.plot(CLA_object_final(),"CMSY") 
      pic_D_ready <- showNotification(paste("Message: ", "F/Fmsy graph ready"), duration = 5)
      
    })
    
    output$Pred_FFmsy_plot= shiny::renderPlot({
      fs <- responsive_font("Pred_FFmsy_plot", session)
      xxxx= run_pictures$pic_D+
        ggplot2::theme_classic(base_size = fs)+
        ggplot2::theme(legend.position="bottom")
      xxxx
    })
...
###### PARABOLA PLOT
    ...
    observeEvent(input$Start_run,{
      ...
      #   
      #   for (i in 1:n) {
      run_pictures$pic_F=ggkobe.plot(CLA_object_final(),CMSY_run() ,"CMSY") 
    ...
    output$kobe_plot= shiny::renderPlot({
      fs <- responsive_font("kobe_plot", session)
      xxxx= run_pictures$pic_F+
        ggplot2::theme_classic(base_size = fs)
      xxxx
    })

    observeEvent(input$Start_run,{
      run_pictures$pic_G= ggmanagement.plot(CLA_object_final(),CMSY_run(),"CMSY")
    ...
    observeEvent(input$Start_run,{
      run_pictures$pic_H= ggprorposterior.plot(CLA_object_final(),CMSY_run(),"CMSY") 
    ...
    CLA_retro=eventReactive(input$Retrospective,{
      req(CLA_object_final())
      xx= retro.fit(CLA_object_final(),input$retro_range,"CMSY")
    })
    ...
    observe({
      req(CLA_object_final())
      nm=object_NAME()
      output$working_directory=renderUI({ shiny::h4(tagList("All your outcomes are stored in the directory: ",  tags$b(paste0(dir.name(),"/CMSY_wd/outputs/",nm))))})
    })
    ...
    observeEvent(input$Start_run, {
      ...
      ggsave(filename=paste0(paste0(dir.name(),"/CMSY_wd/outputs/",nm,"/","Stock_size."),device_),plot=run_pictures$pic_C, device =device_, width = 16, height =10, units = "cm",  dpi = 300)
      ggsave(filename=paste0(paste0(dir.name(),"/CMSY_wd/outputs/",nm,"/","Exploitation_rate."),device_),plot=run_pictures$pic_D, device =device_, width = 16, height =10, units = "cm",  dpi = 300)
      ggsave(filename=paste0(paste0(dir.name(),"/CMSY_wd/outputs/",nm,"/","Equilibrium_curve."),device_),plot=run_pictures$pic_E, device =device_, width = 16, height =10, units = "cm",  dpi = 300)
    ...
    observeEvent(input$Start_run, {
      ...
      out_file <- file.path(
        paste0(dir.name(),"/CMSY_wd/outputs/",nm,"/"),
        paste0("report_",nm, format(Sys.time(), "%Y%m%d_%H%M%S"), ".html")
      )
      ...
      Save_done <- showNotification(paste("Message: ", "HTML Report is ready and saved in your working directory"), duration = 5)
    })
