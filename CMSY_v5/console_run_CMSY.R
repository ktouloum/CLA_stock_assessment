...
inp2=read.csv("C:/Users/toulo/Desktop/Her3031_GoB.csv",header = T, stringsAsFactors = F)
...
# Bobj=Bio_obj(inp,smoother_bw=3,ecreep=T,ecreep_yr=1990,ecreepvalue=3,Biom_type=c("CPUE","Biomass")[1],CPUE_CV=0.2,Plot=T,ShowCV=F) 
# 
# 
# 
# Bobj=Bio_obj(inp) 
...
rk_priors=rk.priors(Cobj,c(0.45,0.55))
rk_priors=rk.priors(Cobj,"Medium")

ggplotly(rk_priors$pic)
...
Bpriors=Biom_priors(Cobj,nbk=3,start_bio=Stock_states[4],
            int_bio=Stock_states[3],int_bio_year=1990,end_bio=Stock_states[1], Plot=T)
  
ggplotly(Bpriors$pic)
...
CLA_stock=CLA_stock_maker(Stock="Stock_11",
...
fit.obj=CLA.fit(CLA_stock,METHOD=c("CMSY","BSM")[1])
...
ggrk.plot(CLA_stock_2,fit.obj,"CMSY")

xxx=ggrk.plot(CLA_stock_2,fit.obj,"CMSY")+ggtitle("AED") 
...
ggcatch.plot(CLA_stock_2,"CMSY",Management=F)
xxx=ggcatch.plot(CLA_stock_2,"CMSY",Management=F)+ggtitle("AED") 

ggplotly(xxx)


ggbk.plot(CLA_stock_2,"CMSY",Management=F)

ggFFmsy.plot(CLA_stock_2,"CMSY",Management=F)
ggparabola.plot(CLA_stock_2,"CMSY")
ggplotly(ggparabola.plot(CLA_stock_2,"CMSY")+ggtitle("AAA") )


ggkobe.plot(CLA_stock_2,fit.obj,"CMSY",Management=F)
ggplotly(ggkobe.plot(CLA_stock_2,fit.obj,"CMSY",Management=F)+ggtitle("AAA") )

ggmanagement.plot(CLA_stock_2,fit.obj,"CMSY")
ggprorposterior.plot(CLA_stock_2,fit.obj,"CMSY")

ggpdiagnostics.plot(CLA_stock_2,fit.obj,"CMSY")

###### 11th step: Run retrospective. ret_steps is the number of years to go back

retr=retro.fit(CLA_stock_2,ret_steps=3,"CMSY")
...
gg_summary.plot(CLA_stock_2,fit.obj,METHOD="CMSY")

ggkiel.plot(CLA_stock_2,METHOD="CMSY")
